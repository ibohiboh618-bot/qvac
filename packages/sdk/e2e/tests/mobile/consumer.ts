...
export const executor = createExecutor({
  handlers: [
    ...
    ...(Platform.OS === "ios" ? [
      // QVAC-19557: Chatterbox iOS peak-memory mitigation — q8_0 T3 KV (nCtx 4096)
      // + q8_0 S3Gen GGUF brings the Device Farm peak under budget, so the
      // tts-chatterbox-* variants are no longer skipped on iOS.
      skipTests([
        "ocr-sign-image",
        "ocr-chart-image",
        "ocr-no-text-image",
