# OVERLAY (local, pre-registry): vlm-benchmark A/B — pin a specific qvac-fabric
# commit so llm-llamacpp builds against it instead of the v${VERSION} registry tag.
# This overlay's REF+SHA512 is the ONLY delta between the baseline ref (pre-PR#172
# fabric, merge-base on temp-9341) and the optimized ref (PR#172 head). QVAC-21361:
# Gemma 4 E2B encoder token-count + Android Vulkan build + Mali flash-attn tuning.
vcpkg_from_github(
