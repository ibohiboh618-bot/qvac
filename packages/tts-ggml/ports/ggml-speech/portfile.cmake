# ggml-speech — LOCAL OVERLAY PORT (QVAC-20557 Bug-1 SVE/armv9 CPU-tone verify; DO NOT MERGE).
#
# Identical to the registry ggml-speech port EXCEPT the pin: this overlay points at
# tetherto/qvac-ext-ggml branch QVAC-20557-sve-vecdot-tail-fix-verify (off the fix
# branch / PR #30). That branch is the registry speech tip + the ggml_vec_dot_f32
# SVE leftover-tail fix (svmad_f32_m -> svmla_f32_m) + verify-only scaffolding:
#   - TTS_SVE_DOT_UNFIXED env toggle -> forces the OLD svmad tail (reproduces the
#     ~12 kHz Nyquist tone) so one binary runs the pre-fix vs post-fix A/B.
#   - a once-per-process [sve-diag] fprintf(stderr) printing svcntb/epr/active tail,
#     so the device console proves the armv9 SVE-128 variant (svcntb=16, epr=4) ran.
# tts-cpp is consumed UNCHANGED from the registry (CPU-only run; no Mali changes).
#
# REF/SHA512 are filled by ~/workstuff/overlay-bump.sh. This overlay (and its
# overlay-ports entry in vcpkg-configuration.json) is throwaway verify scaffolding.

vcpkg_from_github(
    OUT_SOURCE_PATH SOURCE_PATH
    REPO tetherto/qvac-ext-ggml
    REF 09c432e34bb42c8187c2e8d395afb01847bcdd48
    SHA512 447720ed86df771533793d74da4d110534f6a9acb308616865cade31502a06c6e5440dfae5d971f731f2bf40fc2625a3be9b993bbea4988c1a55574527a0de53
    HEAD_REF speech
)
