# TEMPORARY local-validation overlay of the registry qvac-fabric port.
#
# It pins the llama.cpp source to a fork commit that carries the
# heap-use-after-free fix in common_init_from_model_and_params (the bug the
# ASan-instrumented fabric surfaced). Everything below mirrors the registry
# port at qvac-fabric@8828.0.2; only the source REPO/REF/SHA512 differ.
#
# Remove this overlay once the fix lands in qvac-registry-vcpkg and fabric's
# vcpkg.json baseline is bumped to the new version.
vcpkg_from_github(
  OUT_SOURCE_PATH SOURCE_PATH
  REPO jpgaribotti/qvac-fabric-llm.cpp
  REF 7b1b948592007aafdd4e634824f62db9556d9251
  SHA512 c678e22efacf714cd48e6d56714c59a444bbbda8247d23e8d06f03895d9af2f77d765e68eb4c8ae7a075e38c96c7f05f5ee1673a8983bfee94a1f430164a623a
)
