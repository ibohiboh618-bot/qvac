# OVERLAY (local, pre-registry): shared qvac-fabric port pinning the PR #172 HEAD
# commit instead of the v${VERSION} tag, so every fabric consumer builds against
# the complete unreleased fabric fixes before the version is published
# (QVAC-21361: Gemma 4 encoder token-count + Android Vulkan build + Mali
# budget-aware flash-attention speedup + PR review fixes). Revert to
# `REF v${VERSION}` once the matching version is published in qvac-registry-vcpkg.
vcpkg_from_github(
  OUT_SOURCE_PATH SOURCE_PATH
  REPO tetherto/qvac-fabric-llm.cpp
  REF 9509621b0d8c5d1af6655e6b8fdca31528608561
  SHA512 c1a375d671c349357afafb48c51b2519feeb70ee776cfe56fc4ae3811662545861f8544b43157dfabb272d21cfee84f6e895cc5a41d695b9dc344ebe4ab713df
)
