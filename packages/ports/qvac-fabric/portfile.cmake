# OVERLAY (Phase A validation — DO NOT LAND): pins fabric PR #170 head
# (feat/opencl-vision-encoder-qwen3vl-s25, base temp-9341) to validate the
# 9341.1.1 rollout across all 6 consumers BEFORE tagging/publishing.
# Remove this port + the consumers' "overlay-ports" blocks in Phase B2 and
# restore `REF v${VERSION}` resolution via the registry.
vcpkg_from_github(
