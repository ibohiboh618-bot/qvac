...
// .github/actions/normalize-gpr-fabric-prebuilds/normalize-fabric-name.cjs.
// It lives here too because the mobile integration workflows sparse-checkout
// only .github/actions/run-mobile-integration-tests, so the build-mobile-app
// action cannot reach the sibling action's copy on the runner.
