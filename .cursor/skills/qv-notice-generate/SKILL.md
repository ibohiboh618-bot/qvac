...
- Constants (allowlist, normalization, copyright): `.cursor/skills/qv-notice-generate/scripts/constants.js`
- Package definitions & internal wiring: `.cursor/skills/qv-notice-generate/scripts/lib/config.js`
